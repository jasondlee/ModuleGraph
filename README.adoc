...
This is (so far) a fairly simple TamboUI application intended to help visualize and analyze WildFly's module graph. Current features include:
...
$ mvn package
...
$ java -jar java -jar target/modulegraph-1.0-SNAPSHOT.jar /path/to/module/root
```

You can also run the application via JBang[https://jbang.dev]:

```
$ jbang https://github.com/jasondlee/ModuleGraph/blob/master/modulegraph.java
```
